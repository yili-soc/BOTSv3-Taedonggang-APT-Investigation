...
A one-page summary of this report, with the timeline and headline findings, is available in the
[repository README](../README.md). This document is the full incident analysis: attack chain,
evidence, and coverage boundaries. Deployable detection analytics, the IOC bundle, and the ATT&CK
mapping are delivered separately in the [detection pack](../detection-pack.md).
